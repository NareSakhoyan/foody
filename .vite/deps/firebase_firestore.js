...
class __PRIVATE_RestConnection {
  constructor(e) {
    ...
    this.To = t + "://" + e.host, this.Eo = "projects/" + this.databaseId.projectId + "/databases/" + this.databaseId.database + "/documents";
  }
  get Ao() {
    return false;
  }
  Ro(e, t, n, r2, i) {
    const s = __PRIVATE_generateUniqueDebugId(), o = this.Vo(e, t);
    __PRIVATE_logDebug("RestConnection", `Sending RPC '${e}' ${s}:`, o, n);
    const _ = {};
    return this.mo(_, r2, i), this.fo(e, o, _, n).then((t2) => (__PRIVATE_logDebug("RestConnection", `Received RPC '${e}' ${s}: `, t2), t2), (t2) => {
      throw __PRIVATE_logWarn("RestConnection", `RPC '${e}' ${s} failed with error: `, t2, "url: ", o, "request:", n), t2;
    });
  }
  po(e, t, n, r2, i, s) {
    return this.Ro(e, t, n, r2, i);
  }
  /**
  ...
  yo(e, t, n) {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (_.xmlHttpFactory = new FetchXmlHttpFactory({})), this.mo(_.initMessageHeaders, t, n), // Sending the custom headers we just added to request.initMessageHeaders
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(e, t, n = 1e3, r2 = 1.5, i = 6e4) {
    this.ii = e, this.timerId = t, this.wo = n, this.So = r2, this.bo = i, this.Do = 0, this.vo = null, /** The last backoff attempt, as epoch milliseconds. */
  ...
  Mo(e) {
    this.cancel();
    const t = Math.floor(this.Do + this.xo()), n = Math.max(0, Date.now() - this.Co), r2 = Math.max(0, t - n);
    r2 > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r2} ms (base delay: ${this.Do} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.vo = this.ii.enqueueAfterDelay(this.timerId, r2, () => (this.Co = Date.now(), e())), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
    this.Do *= this.So, this.Do < this.wo && (this.Do = this.wo), this.Do > this.bo && (this.Do = this.bo);
  }
  Oo() {
...
var __PRIVATE_PersistentStream = class {
  constructor(e, t, n, r2, i, s, o, _) {
    this.ii = e, this.No = n, this.Bo = r2, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, /**
     * A close count that's incremented every time the stream is closed; used by
     * getCloseGuardedDispatcher() to invalidate callbacks that happen after
     * close.
     */
    this.Lo = 0, this.ko = null, this.qo = null, this.stream = null, this.Qo = new __PRIVATE_ExponentialBackoff(e, t);
  }
  /**
  ...
  async close(e, t) {
    ...
    this.Lo++, 4 !== e ? (
      ...
      (__PRIVATE_logError(t.toString()), __PRIVATE_logError("Using maximum backoff delay to prevent overloading the backend."), this.Qo.Fo())
  ...
  auth() {
    this.state = 1;
    const e = this.Zo(this.Lo), t = this.Lo;
    Promise.all([this.authCredentialsProvider.getToken(), this.appCheckCredentialsProvider.getToken()]).then(([e2, n]) => {
      this.Lo === t && // Normally we'd have to schedule the callback on the AsyncQueue.
  ...
  Xo(e, t) {
    ...
    this.stream = this.t_(e, t), this.stream._o(() => {
      n(() => (this.state = 2, this.qo = this.ii.enqueueAfterDelay(this.Bo, 1e4, () => (this.$o() && (this.state = 3), Promise.resolve())), this.listener._o()));
    }), this.stream.uo((e2) => {
      n(() => this.e_(e2));
  ...
  Zo(e) {
    return (t) => {
      this.ii.enqueueAndForget(() => this.Lo === e ? t() : (__PRIVATE_logDebug("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve()));
    };
  }
};
...
var __PRIVATE_PersistentWriteStream = class extends __PRIVATE_PersistentStream {
  constructor(e, t, n, r2, i, s) {
    super(e, "write_stream_connection_backoff", "write_stream_idle", "health_check_timeout", t, n, r2, s), this.serializer = i, this.s_ = false;
  }
  /**
  ...
  start() {
    this.s_ = false, this.lastStreamToken = void 0, super.start();
  }
  Yo() {
    this.s_ && this.__([]);
  }
  ...
  onMessage(e) {
    if (
      ...
      __PRIVATE_hardAssert(!!e.streamToken), this.lastStreamToken = e.streamToken, this.s_
    ) {
      this.Qo.reset();
      const t = __PRIVATE_fromWriteResults(e.writeResults, e.commitTime), n = __PRIVATE_fromVersion(e.commitTime);
      return this.listener.a_(n, t);
    }
    return __PRIVATE_hardAssert(!e.writeResults || 0 === e.writeResults.length), this.s_ = true, this.listener.u_();
  }
  /**
...
var __PRIVATE_DatastoreImpl = class extends class Datastore {
  ...
  constructor(e, t, n, r2) {
    super(), this.authCredentials = e, this.appCheckCredentials = t, this.connection = n, this.serializer = r2, this.l_ = false;
  }
  h_() {
    if (this.l_)
  ...
  Ro(e, t, n) {
    return this.h_(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([r2, i]) => this.connection.Ro(e, t, n, r2, i)).catch((e2) => {
  ...
  po(e, t, n, r2) {
    return this.h_(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, s]) => this.connection.po(e, t, n, i, s, r2)).catch((e2) => {
      throw "FirebaseError" === e2.name ? (e2.code === v2.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), e2) : new FirestoreError(v2.UNKNOWN, e2.toString());
    });
  }
  terminate() {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
  var r2;
  const i = __PRIVATE_debugCast(e), { request: s, P_: o } = function __PRIVATE_toRunAggregationQueryRequest(e2, t2, n2) {
  ...
  i.connection.Ao || delete s.parent;
  const a = (await i.po(
    "RunAggregationQuery",
    _,
    s,
...
var __PRIVATE_OnlineStateTracker = class {
  ...
  d_() {
    0 === this.I_ && (this.A_(
      "Unknown"
      /* OnlineState.Unknown */
    ), this.T_ = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, () => (this.T_ = null, this.R_("Backend didn't respond within 10 seconds."), this.A_(
      "Offline"
      /* OnlineState.Offline */
    ), Promise.resolve())));
  }
   ...
   */
  V_(e) {
    "Online" === this.state ? this.A_(
      "Unknown"
      /* OnlineState.Unknown */
    ) : (this.I_++, this.I_ >= 1 && (this.m_(), this.R_(`Connection failed 1 times. Most recent error: ${e.toString()}`), this.A_(
      "Offline"
      /* OnlineState.Offline */
    )));
  }
   ...
   */
  set(e) {
    this.m_(), this.I_ = 0, "Online" === e && // We've connected to watch at least once. Don't warn the developer
    // about being offline going forward.
    (this.E_ = false), this.A_(e);
  }
  A_(e) {
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
    this.E_ ? (__PRIVATE_logError(t), this.E_ = false) : __PRIVATE_logDebug("OnlineStateTracker", t);
  }
  m_() {
...
var __PRIVATE_RemoteStoreImpl = class {
  constructor(e, t, n, r2, i) {
     ...
     */
    this.g_ = /* @__PURE__ */ new Map(), /**
     * A set of reasons for why the RemoteStore may be offline. If empty, the
     * RemoteStore may start its network connections.
     */
    this.p_ = /* @__PURE__ */ new Set(), /**
     ...
     */
    this.y_ = [], this.w_ = i, this.w_.Ys((e2) => {
      n.enqueueAndForget(async () => {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug("RemoteStore", "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e3) {
          ...
          ), await __PRIVATE_disableNetworkInternal(t2), t2.S_.set(
            "Unknown"
            /* OnlineState.Unknown */
          ), t2.p_.delete(
            4
    ...
    }), this.S_ = new __PRIVATE_OnlineStateTracker(n, r2);
  }
};
...
function __PRIVATE_remoteStoreListen(e, t) {
  const n = __PRIVATE_debugCast(e);
  n.g_.has(t.targetId) || // Mark this as something the client is currently listening for.
  (n.g_.set(t.targetId, t), __PRIVATE_shouldStartWatchStream(n) ? (
    // The listen will be sent in onWatchStreamOpen
    __PRIVATE_startWatchStream(n)
  ) : __PRIVATE_ensureWatchStream(n).$o() && __PRIVATE_sendWatchRequest(n, t));
}
function __PRIVATE_remoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = __PRIVATE_ensureWatchStream(n);
  n.g_.delete(t), r2.$o() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.g_.size && (r2.$o() ? r2.Go() : __PRIVATE_canUseNetwork(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
...
function __PRIVATE_shouldStartWatchStream(e) {
  return __PRIVATE_canUseNetwork(e) && !__PRIVATE_ensureWatchStream(e).Ko() && e.g_.size > 0;
}
...
async function __PRIVATE_onWatchStreamClose(e, t) {
  ...
  __PRIVATE_shouldStartWatchStream(e) ? (e.S_.V_(t), __PRIVATE_startWatchStream(e)) : (
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
    ...
    try {
      ...
      async function __PRIVATE_handleTargetError(e2, t2) {
        ...
        for (const r2 of t2.targetIds)
          e2.g_.has(r2) && (await e2.remoteSyncer.rejectListen(r2, n2), e2.g_.delete(r2), e2.b_.removeTarget(r2));
      }(e, t);
    } catch (n2) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.b_.We(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.b_.Ze(t) : e.b_.je(t), !n.isEqual(SnapshotVersion.min()))
    try {
      ...
      */
      function __PRIVATE_raiseWatchSnapshot(e2, t3) {
        const n2 = e2.b_.st(t3);
        return n2.targetChanges.forEach((n3, r2) => {
          if (n3.resumeToken.approximateByteSize() > 0) {
            const i = e2.g_.get(r2);
            i && e2.g_.set(r2, i.withResumeToken(n3.resumeToken, t3));
          }
        }), // Re-establish listens for the targets that have been invalidated by
        // existence filter mismatches.
        n2.targetMismatches.forEach((t4, n3) => {
          const r2 = e2.g_.get(t4);
          if (!r2)
            return;
          e2.g_.set(t4, r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, r2.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  ...
  await __PRIVATE_disableNetworkInternal(e), e.S_.set(
    "Offline"
    /* OnlineState.Offline */
  ...
  e.asyncQueue.enqueueRetryable(async () => {
    __PRIVATE_logDebug("RemoteStore", "Retrying IndexedDB access"), await n(), e.p_.delete(
      1
      /* OfflineCause.IndexedDbFailed */
...
async function __PRIVATE_fillWritePipeline(e) {
  ...
  let r2 = t.f_.length > 0 ? t.f_[t.f_.length - 1].batchId : -1;
...
function __PRIVATE_shouldStartWriteStream(e) {
  return __PRIVATE_canUseNetwork(e) && !__PRIVATE_ensureWriteStream(e).Ko() && e.f_.length > 0;
}
...
async function __PRIVATE_onMutationResult(e, t, n) {
  const r2 = e.f_.shift(), i = MutationBatchResult.from(r2, t, n);
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t && __PRIVATE_ensureWriteStream(e).o_ && // This error affects the actual write.
  await async function __PRIVATE_handleWriteError(e2, t2) {
    if (function __PRIVATE_isPermanentWriteError(e3) {
      ...
      const n = e2.f_.shift();
      __PRIVATE_ensureWriteStream(e2).Wo(), await __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), // It's possible that with the completion of this mutation
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  ...
  n.S_.set(
    "Unknown"
    /* OnlineState.Unknown */
  ), await n.remoteSyncer.handleCredentialChange(t), n.p_.delete(
    3
    /* OfflineCause.CredentialChange */
...
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  ...
  ), await __PRIVATE_enableNetworkInternal(n)) : t || (n.p_.add(
    2
    /* OfflineCause.IsSecondary */
  ), await __PRIVATE_disableNetworkInternal(n), n.S_.set(
    "Unknown"
    /* OnlineState.Unknown */
  ));
}
function __PRIVATE_ensureWatchStream(e) {
  return e.D_ || // Create stream (but note that it is not started yet).
  (e.D_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    const r2 = __PRIVATE_debugCast(e2);
    return r2.h_(), new __PRIVATE_PersistentListenStream(t, r2.connection, r2.authCredentials, r2.appCheckCredentials, r2.serializer, n);
    ...
    t ? (e.D_.Wo(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.S_.set(
      "Unknown"
      /* OnlineState.Unknown */
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.v_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    const r2 = __PRIVATE_debugCast(e2);
    return r2.h_(), new __PRIVATE_PersistentWriteStream(t, r2.connection, r2.authCredentials, r2.appCheckCredentials, r2.serializer, n);
  }(e.datastore, e.asyncQueue, {
    ...
    t ? (e.v_.Wo(), // This will start the write stream if necessary.
    await __PRIVATE_fillWritePipeline(e)) : (await e.v_.stop(), e.f_.length > 0 && (__PRIVATE_logDebug("RemoteStore", `Stopping write stream with ${e.f_.length} pending writes`), e.f_ = []));
  })), e.v_;
}
...
var __PRIVATE_DocumentChangeSet = class {
  ...
  track(e) {
    const t = e.doc.key, n = this.C_.get(t);
    n ? (
      // Merge the new change with the existing change.
      0 !== e.type && 3 === n.type ? this.C_ = this.C_.insert(t, e) : 3 === e.type && 1 !== n.type ? this.C_ = this.C_.insert(t, {
        type: n.type,
        doc: e.doc
      }) : 2 === e.type && 2 === n.type ? this.C_ = this.C_.insert(t, {
        type: 2,
        doc: e.doc
      }) : 2 === e.type && 0 === n.type ? this.C_ = this.C_.insert(t, {
        type: 0,
        doc: e.doc
      }) : 1 === e.type && 0 === n.type ? this.C_ = this.C_.remove(t) : 1 === e.type && 2 === n.type ? this.C_ = this.C_.insert(t, {
        type: 1,
        doc: n.doc
      }) : 0 === e.type && 1 === n.type ? this.C_ = this.C_.insert(t, {
        type: 2,
        doc: e.doc
      }) : (
  ...
  F_() {
    const e = [];
    return this.C_.inorderTraversal((t, n) => {
      e.push(n);
    }), e;
  }
};
...
var __PRIVATE_EventManagerImpl = class {
  constructor() {
    this.queries = new ObjectMap((e) => __PRIVATE_canonifyQuery(e), __PRIVATE_queryEquals), this.onlineState = "Unknown", this.x_ = /* @__PURE__ */ new Set();
  }
};
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  t.O_(n.onlineState), s.M_) {
    t.N_(s.M_) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
  }
}
...
var __PRIVATE_QueryListener = class {
  constructor(e, t, n) {
    this.query = e, this.B_ = t, /**
     * Initial snapshots (e.g. from cache) may not be propagated to the wrapped
     * observer. This flag is set to true once we've actually raised an event.
     */
    this.L_ = false, this.k_ = null, this.onlineState = "Unknown", this.options = n || {};
  }
  /**
  ...
  N_(e) {
    ...
    let t = false;
    return this.L_ ? this.q_(e) && (this.B_.next(e), t = true) : this.Q_(e, this.onlineState) && (this.K_(e), t = true), this.k_ = e, t;
  }
  onError(e) {
    this.B_.error(e);
  }
  ...
  O_(e) {
    this.onlineState = e;
    let t = false;
    return this.k_ && !this.L_ && this.Q_(this.k_, e) && (this.K_(this.k_), t = true), t;
  }
  Q_(e, t) {
    if (!e.fromCache)
      return true;
    const n = "Offline" !== t;
    return (!this.options.U_ || !n) && (!e.docs.isEmpty() || e.hasCachedResults || "Offline" === t);
  }
  q_(e) {
  ...
  K_(e) {
    e = ViewSnapshot.fromInitialDocuments(e.query, e.docs, e.mutatedKeys, e.fromCache, e.hasCachedResults), this.L_ = true, this.B_.next(e);
  }
};
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.z_ = e, this.localStore = t, this.serializer = n, /** Batched queries to be saved into storage */
  ...
  j_(e) {
    ...
    if (e.W_.namedQuery)
      this.queries.push(e.W_.namedQuery);
    else if (e.W_.documentMetadata) {
      this.documents.push({
        metadata: e.W_.documentMetadata
      }), e.W_.documentMetadata.exists || ++t;
      const n = ResourcePath.fromString(e.W_.documentMetadata.name);
      this.collectionGroups.add(n.get(n.length - 2));
    } else
      e.W_.document && (this.documents[this.documents.length - 1].document = e.W_.document, ++t);
   ...
   */
  async complete() {
    const e = await __PRIVATE_localStoreApplyBundledDocuments(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.z_.id), t = this.H_(this.documents);
    for (const e2 of this.queries)
      await __PRIVATE_localStoreSaveNamedQuery(this.localStore, e2, t.get(e2.name));
    return this.progress.taskState = "Success", {
      progress: this.progress,
      J_: this.collectionGroups,
      Y_: e
    };
  }
};
...
var __PRIVATE_View = class {
  constructor(e, t) {
    this.query = e, this.Z_ = t, this.X_ = null, this.hasCachedResults = false, /**
    ...
    this.mutatedKeys = __PRIVATE_documentKeySet(), this.ta = __PRIVATE_newQueryComparator(e), this.na = new DocumentSet(this.ta);
  }
  /**
   ...
   */
  ia(e, t) {
    const n = t ? t.sa : new __PRIVATE_DocumentChangeSet(), r2 = t ? t.na : this.na;
    ...
    if (e.inorderTraversal((e2, t2) => {
      ...
      if (u && c) {
        u.data.isEqual(c.data) ? l2 !== h && (n.track({
          type: 3,
          doc: c
        }), P2 = true) : this.oa(u, c) || (n.track({
          type: 2,
          doc: c
        }), P2 = true, (_ && this.ta(c, _) > 0 || a && this.ta(c, a) < 0) && // This doc moved from inside the limit to outside the limit.
  ...
  applyChanges(e, t, n) {
    ...
    }(e2.type, t2.type) || this.ta(e2.doc, t2.doc)), this._a(n);
    const s = t ? this.aa() : [], o = 0 === this.ea.size && this.current ? 1 : 0, _ = o !== this.X_;
    if (this.X_ = o, 0 !== i.length || _) {
      return {
   ...
   */
  ca(e) {
    return !this.Z_.has(e) && // The local store doesn't think it's a result, so it shouldn't be in limbo.
    (!!this.na.has(e) && !this.na.get(e).hasLocalMutations);
  }
  /**
   ...
   */
  _a(e) {
    e && (e.addedDocuments.forEach((e2) => this.Z_ = this.Z_.add(e2)), e.modifiedDocuments.forEach((e2) => {
    }), e.removedDocuments.forEach((e2) => this.Z_ = this.Z_.delete(e2)), this.current = e.current);
  }
  aa() {
    if (!this.current)
      return [];
    const e = this.ea;
    this.ea = __PRIVATE_documentKeySet(), this.na.forEach((e2) => {
      this.ca(e2.key) && (this.ea = this.ea.add(e2.key));
    });
    const t = [];
    return e.forEach((e2) => {
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r2, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r2, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Ia = {}, this.Ta = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.Ea = /* @__PURE__ */ new Map(), /**
     ...
     */
    this.Ra = /* @__PURE__ */ new Map(), this.Va = new __PRIVATE_ReferenceSet(), /** Stores user completion handlers, indexed by User and BatchId. */
    this.ma = {}, /** Stores user callbacks waiting for all pending writes to be acknowledged. */
    this.fa = /* @__PURE__ */ new Map(), this.ga = __PRIVATE_TargetIdGenerator.On(), this.onlineState = "Unknown", // The primary state is set to `true` or `false` immediately after Firestore
...
async function __PRIVATE_syncEngineListen(e, t) {
  ...
  const s = n.Ta.get(t);
  if (s)
    r2 = s.targetId, n.sharedClientState.addLocalQueryTarget(r2), i = s.view.ha();
  else {
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r2, i) {
  e.ya = (t2, n2, r3) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r4) {
    let i2 = t3.view.ia(n3);
    ...
    (i2 = await __PRIVATE_localStoreExecuteQuery(
      ...
      /* usePreviousResults= */
      false
    ).then(({ documents: e3 }) => t3.view.ia(e3, i2)));
    ...
    return __PRIVATE_updateTrackedLimbos(e2, t3.targetId, o2.ua), o2.snapshot;
  }(e, t2, n2, r3);
  const s = await __PRIVATE_localStoreExecuteQuery(
    ...
    /* usePreviousResults= */
    true
  ), o = new __PRIVATE_View(t, s.ss), _ = o.ia(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r2 && "Offline" !== e.onlineState, i), u = o.applyChanges(
    _,
    /* updateLimboDocuments= */
    e.isPrimaryClient,
    a
  );
  __PRIVATE_updateTrackedLimbos(e, n, u.ua);
  const c = new __PRIVATE_QueryView(t, n, o);
  return e.Ta.set(t, c), e.Ea.has(n) ? e.Ea.get(n).push(t) : e.Ea.set(n, [t]), u.snapshot;
}
async function __PRIVATE_syncEngineUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = n.Ta.get(t), i = n.Ea.get(r2.targetId);
  if (i.length > 1)
    return n.Ea.set(r2.targetId, i.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void n.Ta.delete(t);
...
async function __PRIVATE_syncEngineWrite(e, t, n) {
  ...
  try {
    ...
    r2.sharedClientState.addPendingMutation(e2.batchId), function __PRIVATE_addMutationCallback(e3, t2, n2) {
      let r3 = e3.ma[e3.currentUser.toKey()];
      r3 || (r3 = new SortedMap(__PRIVATE_primitiveComparator));
      r3 = r3.insert(t2, n2), e3.ma[e3.currentUser.toKey()] = r3;
...
function __PRIVATE_syncEngineApplyOnlineStateChange(e, t, n) {
  ...
  if (r2.isPrimaryClient && 0 === n || !r2.isPrimaryClient && 1 === n) {
    ...
    }(r2.eventManager, t), e2.length && r2.Ia.n_(e2), r2.onlineState = t, r2.isPrimaryClient && r2.sharedClientState.setOnlineState(t);
  }
}
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  const r2 = __PRIVATE_debugCast(e);
  r2.sharedClientState.updateQueryState(t, "rejected", n);
  const i = r2.Ra.get(t), s = i && i.key;
  if (s) {
    ...
    r2.Aa = r2.Aa.remove(s), r2.Ra.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r2);
  } else
...
async function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
  ...
  try {
    ...
    const r2 = n.fa.get(e2) || [];
    r2.push(t), n.fa.set(e2, r2);
  } catch (e2) {
...
function __PRIVATE_triggerPendingWritesCallbacks(e, t) {
  (e.fa.get(t) || []).forEach((e2) => {
    e2.resolve();
  }), e.fa.delete(t);
}
function __PRIVATE_processUserCallback(e, t, n) {
  const r2 = __PRIVATE_debugCast(e);
  let i = r2.ma[r2.currentUser.toKey()];
  if (i) {
    const e2 = i.get(t);
    e2 && (n ? e2.reject(n) : e2.resolve(), i = i.remove(t)), r2.ma[r2.currentUser.toKey()] = i;
  }
}
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  e.sharedClientState.removeLocalQueryTarget(t);
  for (const r2 of e.Ea.get(t))
    e.Ta.delete(r2), n && e.Ia.wa(r2, n);
  if (e.Ea.delete(t), e.isPrimaryClient) {
    e.Va.Ar(t).forEach((t2) => {
...
function __PRIVATE_removeLimboTarget(e, t) {
  ...
  const n = e.Aa.get(t);
  null !== n && (__PRIVATE_remoteStoreUnlisten(e.remoteStore, n), e.Aa = e.Aa.remove(t), e.Ra.delete(n), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
...
function __PRIVATE_trackLimboChange(e, t) {
  ...
  e.Aa.get(n) || e.da.has(r2) || (__PRIVATE_logDebug("SyncEngine", "New document in limbo: " + n), e.da.add(r2), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.da.size > 0 && e.Aa.size < e.maxConcurrentLimboResolutions; ) {
    const t = e.da.values().next().value;
    e.da.delete(t);
    const n = new DocumentKey(ResourcePath.fromString(t)), r2 = e.ga.next();
    e.Ra.set(r2, new LimboResolution(n)), e.Aa = e.Aa.insert(n, r2), __PRIVATE_remoteStoreListen(e.remoteStore, new TargetData(__PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(n.path)), r2, "TargetPurposeLimboResolution", __PRIVATE_ListenSequence.ae));
  }
}
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  const r2 = __PRIVATE_debugCast(e), i = [], s = [], o = [];
  r2.Ta.isEmpty() || (r2.Ta.forEach((e2, _) => {
    o.push(r2.ya(_, t, n).then((e3) => {
      if (
  ...
  }), await Promise.all(o), r2.Ia.n_(i), await async function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
...
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = n.Ra.get(t);
  if (r2 && r2.Pa)
    return __PRIVATE_documentKeySet().add(r2.key);
  {
    ...
    if (!r3)
      return e2;
    for (const t2 of r3) {
      const r4 = n.Ta.get(t2);
      e2 = e2.unionWith(r4.view.ra);
    }
    return e2;
  }
}
async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  ...
  return n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, i.ua), i;
}
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.pa) {
    ...
    n.pa = true, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
    for (const e3 of t2)
      __PRIVATE_remoteStoreListen(n.remoteStore, e3);
  } else if (false === t && false !== n.pa) {
    const e2 = [];
    ...
    function __PRIVATE_resetLimboDocuments(e3) {
      ...
      }), t3.Va.Rr(), t3.Ra = /* @__PURE__ */ new Map(), t3.Aa = new SortedMap(DocumentKey.comparator);
    }(n), n.pa = false, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
  }
}
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  ...
  for (const e2 of t) {
    let t2;
    const n2 = r2.Ea.get(e2);
    if (n2 && 0 !== n2.length) {
      t2 = await __PRIVATE_localStoreAllocateTarget(r2.localStore, __PRIVATE_queryToTarget(n2[0]));
      for (const e3 of n2) {
        const t3 = r2.Ta.get(e3), n3 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r2, t3);
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r2.pa) {
    ...
    for (const e2 of n)
      r2.Ea.has(e2) && // Release queries that are still active.
      await __PRIVATE_localStoreReleaseTarget(
        r2.localStore,
        e2,
        /* keepPersistedTargetData */
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      for (; s; ) {
        ...
        e3 && n2._updateProgress(e3), s = await t2.Sa();
      }
      ...
      }(e2.localStore, r3), n2._completeWith(o.progress), Promise.resolve(o.J_);
    } catch (e3) {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  constructor(e, t, n) {
    super(), this.ba = e, this.cacheSizeBytes = t, this.forceOwnership = n, this.synchronizeTabs = false;
  }
  async initialize(e) {
    await super.initialize(e), await this.ba.initialize(this, e), // Enqueue writes from a previous session
    await __PRIVATE_syncEngineEnsureWriteCallbacks(this.ba.syncEngine), await __PRIVATE_fillWritePipeline(this.ba.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(
      ...
      /* forceOwnership= */
      false
    ), this.ba = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    ...
    await this.persistence.Vi(async (e2) => {
      await __PRIVATE_syncEngineApplyPrimaryState(this.ba.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
    });
  }
  createSharedClientState(e) {
...
var OnlineComponentProvider = class {
  ...
  createSyncEngine(e, t) {
    return function __PRIVATE_newSyncEngine(e2, t2, n, r2, i, s, o) {
      ...
      return o && (_.pa = true), _;
    }(this.localStore, this.remoteStore, this.eventManager, this.sharedClientState, e.initialUser, e.maxConcurrentLimboResolutions, t);
  }
  terminate() {
    return async function __PRIVATE_remoteStoreShutdown(e) {
      const t = __PRIVATE_debugCast(e);
      __PRIVATE_logDebug("RemoteStore", "RemoteStore shutting down."), t.p_.add(
        5
        /* OfflineCause.Shutdown */
      ), await __PRIVATE_disableNetworkInternal(t), t.w_.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var __PRIVATE_AsyncObserver = class {
  ...
  error(e) {
    this.observer.error ? this.Da(this.observer.error, e) : __PRIVATE_logError("Uncaught Error in snapshot listener:", e.toString());
  }
  va() {
    this.muted = true;
  }
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.Ca = e, this.serializer = t, /** Cached bundle metadata. */
    this.metadata = new __PRIVATE_Deferred(), /**
     * Internal buffer to hold bundle content, accumulating incomplete element
     * content.
     */
    this.buffer = new Uint8Array(), this.Fa = function __PRIVATE_newTextDecoder() {
      return new TextDecoder("utf-8");
    }(), // Read the metadata (which is the first element).
    this.Ma().then((e2) => {
      e2 && e2.G_() ? this.metadata.resolve(e2.W_.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(null == e2 ? void 0 : e2.W_)}`));
  ...
  async Ma() {
    ...
    if (null === e)
      return null;
    const t = this.Fa.decode(e), n = Number(t);
    isNaN(n) && this.Oa(`length string (${t}) is not valid number`);
    const r2 = await this.Na(n);
  ...
  async xa() {
    ...
    if (0 === this.buffer.length)
      return null;
    const e = this.Ba();
    e < 0 && this.Oa("Reached the end of bundle when a length string is expected.");
  ...
  async Na(e) {
    for (; this.buffer.length < e; ) {
      await this.La() && this.Oa("Reached the end of bundle when more is expected.");
    }
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    ...
    const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
      ...
      }, s = await n.po("BatchGetDocuments", r2, i, t2.length), o = /* @__PURE__ */ new Map();
      s.forEach((e3) => {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r2, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r2, this.deferred = i, this.ka = n.maxAttempts, this.Qo = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
  ...
  qa() {
    this.Qo.Mo(async () => {
      const e = new Transaction$2(this.datastore), t = this.Qa(e);
      t && t.then((t2) => {
  ...
  Ka(e) {
    this.ka > 0 && this.$a(e) ? (this.ka -= 1, this.asyncQueue.enqueueAndForget(() => (this.qa(), Promise.resolve()))) : this.deferred.reject(e);
  }
  $a(e) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r2 = await __PRIVATE_localStoreExecuteQuery(
        ...
        /* usePreviousResults= */
        true
      ), i = new __PRIVATE_View(t2, r2.ss), s = i.ia(r2.documents), o = i.applyChanges(
        s,
        /* updateLimboDocuments= */
        false
      );
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    ...
    n.va(), e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor() {
    this.Ua = Promise.resolve(), // A list of retryable operations. Retryable operations are run in order and
    // retried with backoff.
    this.Wa = [], // Is this AsyncQueue being shut down? Once it is set to true, it will not
    // be changed again.
    this.Ga = false, // Operations scheduled to be queued in the future. Operations are
    // automatically removed after they are run or canceled.
    this.za = [], // visible for testing
    this.ja = null, // Flag set while there's an outstanding AsyncQueue operation, used for
    // assertion sanity-checks.
    this.Ha = false, // Enabled during shutdown on Safari to prevent future access to IndexedDB.
    this.Ja = false, // List of TimerIds to fast-forward delays for.
    this.Ya = [], // Backoff timer used to schedule retries for retryable operations
    ...
    this.Za = () => {
      ...
      e2 && __PRIVATE_logDebug("AsyncQueue", "Visibility state changed to " + e2.visibilityState), this.Qo.Oo();
    };
    const e = getDocument();
    e && "function" == typeof e.addEventListener && e.addEventListener("visibilitychange", this.Za);
  }
  get isShuttingDown() {
    return this.Ga;
  }
  ...
  enqueueAndForgetEvenWhileRestricted(e) {
    this.Xa(), // eslint-disable-next-line @typescript-eslint/no-floating-promises
    this.eu(e);
  }
  enterRestrictedMode(e) {
    if (!this.Ga) {
      this.Ga = true, this.Ja = e || false;
      const t = getDocument();
      t && "function" == typeof t.removeEventListener && t.removeEventListener("visibilitychange", this.Za);
    }
  }
  enqueue(e) {
    if (this.Xa(), this.Ga)
    ...
    return this.eu(() => this.Ga && this.Ja ? Promise.resolve() : (e().then(t.resolve, t.reject), t.promise)).then(() => t.promise);
  }
  enqueueRetryable(e) {
  ...
  async tu() {
    if (0 !== this.Wa.length) {
      ...
      this.Wa.length > 0 && // If there are additional operations, we re-schedule `retryNextOp()`.
  ...
  eu(e) {
    const t = this.Ua.then(() => (this.Ha = true, e().catch((e2) => {
      this.ja = e2, this.Ha = false;
      const t2 = (
        /**
    ...
    }).then((e2) => (this.Ha = false, e2))));
    return this.Ua = t, t;
  }
  enqueueAfterDelay(e, t, n) {
    this.Xa(), // Fast-forward delays for timerIds that have been overriden.
    this.Ya.indexOf(e) > -1 && (t = 0);
    const r2 = DelayedOperation.createAndSchedule(this, e, t, n, (e2) => this.nu(e2));
    return this.za.push(r2), r2;
  }
  Xa() {
    this.ja && fail();
  }
  ...
  su(e) {
    return this.ru().then(() => {
      this.za.sort((e2, t) => e2.targetTimeMs - t.targetTimeMs);
      for (const t of this.za)
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  constructor(e, t, n, r2, i, s) {
    ...
    void 0 === i && this._u(), this.fieldTransforms = i || [], this.fieldMask = s || [];
  }
  get path() {
  ...
  cu(e) {
    var t;
    const n = null === (t = this.path) || void 0 === t ? void 0 : t.child(e), r2 = this.uu({
      path: n,
      lu: false
    });
    return r2.hu(e), r2;
  ...
  Tu(e) {
    return __PRIVATE_createError(e, this.settings.methodName, this.settings.Eu || false, this.path, this.settings.du);
  }
  ...
  _u() {
    if (this.path)
      for (let e = 0; e < this.path.length; e++)
        this.hu(this.path.get(e));
  }
  hu(e) {
    if (0 === e.length)
      throw this.Tu("Document fields must not be empty");
    if (__PRIVATE_isWrite(this.au) && pe.test(e))
...
function __PRIVATE_parseSetData(e, t, n, r2, i, s = {}) {
  const o = e.Au(s.merge || s.mergeFields ? 2 : 0, t, n, i);
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.au)
      throw 1 === e.au ? e.Tu(`${this._methodName}() can only appear at the top level of your update data`) : e.Tu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.Ru.map((e2) => __PRIVATE_parseData(e2, t)), r2 = new __PRIVATE_ArrayUnionTransformOperation(n);
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.Ru.map((e2) => __PRIVATE_parseData(e2, t)), r2 = new __PRIVATE_ArrayRemoveTransformOperation(n);
    return new FieldTransform(e.path, r2);
  }
  isEqual(e) {
    return this === e;
...
var __PRIVATE_NumericIncrementFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = new __PRIVATE_NumericIncrementTransformOperation(e.serializer, toNumber(e.serializer, this.Vu));
...
function __PRIVATE_parseUpdateVarargs(e, t, n, r2, i, s) {
  const o = e.Au(1, t, n), _ = [__PRIVATE_fieldPathFromArgument$1(t, r2, n)], a = [i];
  if (s.length % 2 != 0)
...
function __PRIVATE_parseQueryValue(e, t, n, r2 = false) {
  return __PRIVATE_parseData(n, e.Au(r2 ? 4 : 3, t));
}
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.au))
        throw t2.Tu(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.Tu(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    return function __PRIVATE_parseArray(e2, t2) {
      ...
      let r2 = 0;
      for (const i of e2) {
        let e3 = __PRIVATE_parseData(i, t2.Iu(r2));
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r2.isEqual(n))
        throw t2.Tu(`Document reference is for database ${r2.projectId}/${r2.database} but should be for database ${n.projectId}/${n.database}`);
      return {
        referenceValue: __PRIVATE_toResourceName(e2.firestore._databaseId || t2.databaseId, e2._key.path)
      };
    }
    throw t2.Tu(`Unsupported field value: ${__PRIVATE_valueDescription(e2)}`);
  }(e, t);
}
function __PRIVATE_parseObject(e, t) {
  ...
  return isEmpty(e) ? (
    ...
    const i = __PRIVATE_parseData(r2, t.cu(e2));
    null != i && (n[e2] = i);
  }), {
    mapValue: {
      fields: n
...
function __PRIVATE_validatePlainObject(e, t, n) {
  if (!__PRIVATE_looksLikeJsonObject(n) || !function __PRIVATE_isPlainObject(e2) {
    ...
    throw "an object" === r2 ? t.Tu(e + " a custom object") : t.Tu(e + " " + r2);
  }
}
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(S2, "4.0.0", e), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
  registerVersion(S2, "4.0.0", "esm2017");
}();
export {
